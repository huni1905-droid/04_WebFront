...
document.querySelector("#btn1").addEventListener("click", () => {
  ...
  // 2. 마지막 지식으로 추가 ( 요소.append("내용" or 노드) )
  ...
  // 4. 이전/다음 형제로 추가 ( 요소.before / 요소.after("내용" or 노드) )
  // ul의 전/후에 내용 추가
  ul.before("이전입니다", "ㅎㅎ");
  ul.after("이후입니다");
